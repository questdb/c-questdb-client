...
For API usage:
* Rust: `SenderBuilder`'s [`auth`](https://docs.rs/questdb-rs/4.9.0/questdb/ingress/struct.SenderBuilder.html#method.auth)
  and [`tls`](https://docs.rs/questdb-rs/4.9.0/questdb/ingress/struct.SenderBuilder.html#method.tls) methods.
